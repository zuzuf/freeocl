...
namespace FreeOCL
{
	...
	private:
        ...
        std::string macro_expansion(const std::string &text, const set<std::string> &processed_macros = set<std::string>(), const bool b_defined_rule = false);
		bool valid_chunk_for_macro_expansion(const std::string &text);
