...
inline int2 __address_mode(const image2d_t &image, sampler_t sampler, const int2 &coord)
{
	int2 __coord;
	switch(sampler & 0xFF)
	{
...
inline int4 __address_mode(const image3d_t &image, sampler_t sampler, const int4 &coord)
{
	int4 __coord;
	switch(sampler & 0xFF)
	{
